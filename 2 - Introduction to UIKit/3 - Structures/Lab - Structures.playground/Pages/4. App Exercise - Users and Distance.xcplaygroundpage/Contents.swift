...
var myself: User = User(name: "Vasu", age: 19, height: 178, weight: 70, activityLevel: 10)
print("Hello, my name is \(myself.name) and I am \(myself.age) years old.")
print("I am \(myself.height) cm tall and weigh \(myself.weight) kg.")
print("I am level \(myself.activityLevel) active.")
...
struct Distance {
    ...
    init(meters: Double) {
        ...
        print("The Distance() when input is in meters......\nmeters :\(self.meters) \nDistance(feet) in meters : \(self.feet) ")
    }
    ...
    init(feet: Double) {
        ...
        print("The Distance() when input is in feet......\nDistance(meters) in feet :\(self.meters) \nfeet : \(self.feet) ")
    }
}
...
//Yes the feet distance is accurate.

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let Kilometer = Distance(feet: 1000)
