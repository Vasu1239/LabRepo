...
var favoriteBook = Book(title: "Too Good To Be True", author: "Carola Lovering", pages: 350, price: 99.99)
...
var macBookAir = Laptop(yearPurchased: 2025)
var macBookPro = Laptop(repairCount:1,yearPurchased: 2020)
...
struct Height{
    ...
    init(inches:Double){
        ...
        print("The height() when input is in inches......\ninches :\(self.heightInInches) \nHeight(cm) in inches : \(self.heightInCentimeters) ")
    }
    ...
    init(centimeters:Double){
        ...
        print("The height() when input is in centimeters......\nHeight(inches) in cm  :\(self.heightInInches) \ncentimeters : \(self.heightInCentimeters) ")
    }
}

let initializer1 = Height(inches:65)
let initializer2 = Height(centimeters: 50)
...
var myheight = Height(centimeters:65)
