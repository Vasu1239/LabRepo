...
class RegistrationTableViewController: UITableViewController {
    ...
    @IBSegueAction func addEditSegue(_ coder: NSCoder, sender: Any?) -> AddRegistrationTableViewController? {
        guard let indexPath = sender as? IndexPath else { return AddRegistrationTableViewController(coder: coder, registration: nil)}
        return AddRegistrationTableViewController(coder: coder , registration: registrations[indexPath.row])
    }
