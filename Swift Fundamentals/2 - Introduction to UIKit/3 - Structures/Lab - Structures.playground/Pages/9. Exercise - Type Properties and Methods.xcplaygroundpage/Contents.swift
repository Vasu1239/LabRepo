...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Vasu", email:"vasu1239.be23@chitkara.edu.in", age: 19)
 ...
 */
let newUser = User(userName: "Vasu1239", email: "vasy1234@gmail.com", age: 20)
