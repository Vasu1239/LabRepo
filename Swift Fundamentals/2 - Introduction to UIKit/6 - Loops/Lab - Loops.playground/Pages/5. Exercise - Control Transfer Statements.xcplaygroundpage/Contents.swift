...
var country :[String:String] = ["Haryana":"Chandigarh","Uttrakhand":"Dehradun","Gujrat":"Gandhi Nagar","Maharashtra":"Mumbai","Madhya Pradesh":"Bhopal"]

for (state,capital) in country {
    if state == "Haryana" {
