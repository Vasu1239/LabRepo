...
//print("The value of foo is \(foo)")
print("Becoz the scope of foo is inside to the for loop,means foo is not accessible outside of the loop .Because it is the local variable of the loop")
...
print("Because both x have different scopes.First x is a global variable and second x is a local variable of the for loop")
...
var statement1 = greeting(greeting: "Hi there", name: "Sara")
var statement2 = greeting(greeting: nil, name: "Sara")
